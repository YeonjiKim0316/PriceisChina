	 ...
	 <input type="hidden" name="command" value="join">
	  ...
	  <table border="1" cellspacing="1">
		  ...
		  <input type="radio" id="M" name="gender" value="male">
			...
			<td>
			  <input type="radio" id="10" name="age" value="age">
			  <label for="10">10대 이하</label><br>
			  <input type="radio" id="20" name="age" value="age">
			  <label for="20">20대</label><br>
			  <input type="radio" id="30" name="age" value="age">
			  <label for="30">30대</label><br>
			  <input type="radio" id="40" name="age" value="age">
			  <label for="40">40대</label><br>
			  <input type="radio" id="50" name="age" value="age">
			  <label for="50">50대</label><br>
			  <input type="radio" id="60" name="age" value="age">
